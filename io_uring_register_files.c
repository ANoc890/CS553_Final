...
int main() {
    ...
    registered_fds[0] = server_fd;
    io_uring_queue_init(QUEUE_DEPTH, &ring, 0);
    io_uring_register_files(&ring, registered_fds, 1);
